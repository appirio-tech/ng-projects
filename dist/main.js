...
angular.module("appirio-tech-ng-projects").run(["$templateCache", function($templateCache) {$templateCache.put("views/claimed-projects.directive.html","<loader ng-show=\"vm.loading\"></loader><ul class=\"flex wrap\"><li ng-repeat=\"project in vm.projects track by $index\" fitted-width=\"fitted-width\" class=\"elevated-bottom\"><header><a ui-sref=\"copilot-project-details({ id: project.id })\"><h5>{{ project.name || \'Unnamed Project\' }}</h5></a><p class=\"type\">{{ vm.typeMap[project.projectType] }} - 10/23/2015</p></header><main ng-if=\"project.status == \'Assigned\'\" class=\"flex column middle center\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/design.svg\" ng-if=\"project.projectType == \'DESIGN\'\" class=\"icon biggest\"/><img src=\"/images/development.svg\" ng-if=\"project.projectType == \'DESIGN_AND_CODE\'\" class=\"icon biggest\"/><h6>Project Claimed</h6></div><footer class=\"flex bottom center\"><a ui-sref=\"copilot-project-details({ id: project.id })\" class=\"action button\">estimate</a></footer></main><main ng-if=\"project.status == \'Estimate\'\" class=\"flex column middle center\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/define-feature.svg\" class=\"icon biggest\"/><h6>Projected Estimated</h6></div><footer class=\"flex bottom center\"><p>Client is reviewing estimate.</p></footer></main><main ng-if=\"project.status == \'Approved\'\" class=\"flex column middle center\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/brand-reqs.svg\" class=\"icon biggest\"/><h6>Project Approved</h6></div><footer class=\"flex bottom center\"><a ui-sref=\"copilot-project-details({ id: project.id })\" class=\"action button\">create challenges</a></footer></main><main ng-if=\"project.status == \'Launched\'\" class=\"flex column middle center\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/features.svg\" class=\"icon biggest\"/><h6>Project launched</h6></div><footer class=\"flex bottom center\"><p>Relax, have a beer.</p></footer></main><main ng-if=\"project.status == \'Complete\'\" class=\"complete flex column middle center\"><img src=\"/images/features.svg\" class=\"icon biggest\"/><h6>Project complete</h6></main></li></ul><div ng-hide=\"vm.loading || vm.projects.length &gt; 0\" class=\"no-projects\"><p>You have not claimed any projects yet.</p></div>");
$templateCache.put("views/estimate-project.directive.html","<h3>Project Estimate</h3><hr class=\"biggest\"/><form ng-submit=\"vm.submit()\" ng-hide=\"vm.saved\"><div class=\"cost-estimate flex space-between wrap\"><div class=\"cost\"><label>Cost</label><div class=\"fields flex middle\"><input ng-model=\"vm.payload.price.min\" type=\"number\" placeholder=\"$\" required=\"true\" min=\"0\"/><p>to</p><input ng-model=\"vm.payload.price.max\" type=\"number\" placeholder=\"$\" required=\"true\" min=\"0\"/></div></div><div class=\"duration\"><label>Project Duration</label><div class=\"fields flex middle\"><input ng-model=\"vm.payload.duration.min\" type=\"number\" placeholder=\"$\" required=\"true\" min=\"0\"/><p>to</p><input ng-model=\"vm.payload.duration.max\" type=\"number\" placeholder=\"$\" required=\"true\" min=\"0\"/><p>weeks</p></div></div></div><button class=\"action wider\">save estimates</button></form><h3 ng-show=\"vm.saved\" class=\"success\">Esimate saved</h3><loader ng-show=\"vm.loading\"></loader>");
$templateCache.put("views/ng-projects.directive.html","<loader ng-show=\"vm.loading\"></loader><ul class=\"flex wrap\"><li ng-repeat=\"project in vm.projects track by $index\" fitted-width=\"fitted-width\" class=\"elevated-bottom\"><header><a ui-sref=\"timeline({ workId: project.id })\"><h5>{{ project.name || \'Unnamed Project\' }}</h5></a><p class=\"type\">{{ vm.typeMap[project.projectType] }} - {{ project.status }}</p></header><main ng-if=\"project.status == \'Incomplete\'\" class=\"incomplete flex column middle center\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/project-incomplete.svg\" class=\"icon big\"/><h6>Project setup incomplete</h6></div><footer class=\"flex bottom center\"><a ui-sref=\"submit-work({ id: project.id })\" class=\"button action\">continue setup</a></footer></main><main ng-if=\"project.status == \'Submitted\'\" class=\"submitted flex column\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/project-submitted.svg\" class=\"icon big\"/><h6>Project submitted</h6></div><footer class=\"flex column end\"><p>You are waiting for project approval</p><p>This should take about 1 day</p></footer></main><main ng-if=\"project.status == \'Assigned\'\" class=\"assigned flex column\"><div class=\"flex column middle center flex-grow\"><h6>Meet your co-pilot</h6><avatar ng-src=\"{{project.copilot.avatar}}\" class=\"icon big\"></avatar><p>{{ project.copilot.handle || \'n/a\' }}</p></div><footer class=\"flex bottom center\"><a ui-sref=\"messaging({ id: project.id, threadId: \'threadfor-\' + project.id })\" class=\"button action\">send a message</a></footer></main><main ng-if=\"project.status == \'Estimate\'\" class=\"estimated flex column\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/quote-generated.svg\" class=\"icon big\"/><h6>Quote Generated</h6></div><footer class=\"flex bottom center\"><a ui-sref=\"timeline({ workId: project.id })\" class=\"button action\">view quote</a></footer></main><main ng-if=\"project.status == \'Approved\'\" class=\"approved flex column\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/project-approved.svg\" class=\"icon big\"/><h6>Project Approved</h6></div><footer class=\"flex column end\"><p>Blah blah blah blah</p><p>Blah blah blah blah</p></footer></main><main ng-if=\"project.status == \'Launched\'\" class=\"launched flex column\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/project-launched.svg\" class=\"icon big\"/><h6>Project launched</h6></div><footer class=\"flex column end\"><p>Design work is in progress</p><p>Get design submissions in several days.</p></footer></main><main ng-if=\"project.status == \'Complete\'\" class=\"complete flex column middle center\"><div class=\"icon big warning\"></div><h6>Project complete!</h6><button>deploy my app</button></main></li></ul><div ng-hide=\"vm.loading || vm.projects.length &gt; 0\" class=\"no-projects\"><p>You have not started any projects.</p></div>");
$templateCache.put("views/open-projects.directive.html","<loader ng-show=\"vm.loading\"></loader><ul class=\"flex wrap\"><li ng-repeat=\"project in vm.projects track by $index\" fitted-width=\"fitted-width\" class=\"elevated-bottom\"><loader ng-show=\"vm.claiming[project.id]\"></loader><header><a ui-sref=\"copilot-project-details({ id: project.id })\"><h5>{{ project.name || \'Unnamed Project\' }}</h5></a><p class=\"type\">{{ vm.typeMap[project.projectType] }} - 10/23/2015</p></header><main class=\"flex column middle center\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/design.svg\" ng-if=\"project.projectType == \'DESIGN\'\" class=\"flex-grow\"/><img src=\"/images/design-development.svg\" ng-if=\"project.projectType == \'DESIGN_AND_CODE\'\" class=\"flex-grow\"/></div><footer class=\"flex bottom center\"><button ng-click=\"vm.claim(project.id)\" ng-hide=\"vm.claimed[project.id]\" class=\"action button\">claim project</button><div ng-show=\"vm.claimed[project.id]\" class=\"flex middle center\"><div class=\"checkmark-white-house\"><div class=\"icon checkmark-white small\"></div></div><div class=\"claimed\">project claimed</div></div></footer></main></li></ul><div ng-hide=\"vm.loading || vm.projects.length &gt; 0\" class=\"no-projects\"><p>There are no open projects.</p></div>");
$templateCache.put("views/project-details.directive.html","<loader ng-show=\"vm.loading\"></loader><estimate-project project-id=\"{{ vm.id }}\" ng-if=\"userType == \'copilot\' &amp;&amp; vm.project.status == \'Assigned\'\"></estimate-project><div class=\"flex rows\"><div class=\"house nav\"><ul><li><button class=\"clean\">Project setup</button></li><li><button class=\"clean\">Features</button></li><li><button class=\"clean\">Design</button></li><li><button class=\"clean\">Development</button></li></ul></div><ul ng-hide=\"vm.loading\" class=\"requirements flex-grow\"><li><h3>Project Setup</h3><hr class=\"biggest\"/><h4>Uploaded documents</h4><a href=\"#\">abc123.doc (wip)</a><h4>iOS platform details</h4><ul class=\"platform flex space-between\"><li class=\"device\"><h5>Device</h5><ul><li ng-repeat=\"device in vm.project.deviceIds\" class=\"flex middle\"><img src=\"/images/icon-check.svg\" class=\"icon small\"/><span>{{ vm.textMap[device] || device }}</span></li></ul></li><li class=\"orientation\"><h5>Orientation</h5><ul><li ng-repeat=\"orientation in vm.project.orientationIds\" class=\"flex middle\"><img src=\"/images/icon-check.svg\" class=\"icon small\"/><span>{{ vm.textMap[orientation] || orientation }}</span></li></ul></li></ul><h4>Project type</h4><div ng-if=\"vm.project.projectType == \'DESIGN\'\" class=\"project-type flex middle\"><img src=\"/images/design.svg\" class=\"biggest\"/><p>Design</p></div><div ng-if=\"vm.project.projectType != \'DESIGN\'\" class=\"project-type flex middle\"><img src=\"/images/design-development.svg\" class=\"biggest\"/><p>Design &amp; Development</p></div></li><li><h3>Features</h3><hr class=\"biggest\"/><h4>Uploaded documents</h4><a href=\"#\">abc123.doc (wip)</a><h4>Features &amp; descriptions</h4><ul class=\"features-descriptions\"><li ng-repeat=\"feature in vm.project.features\"><p>{{ feature.title }}</p><p>{{ feature.description }}</p><hr/></li></ul></li><li><h3>Design</h3><hr class=\"biggest\"/><h4>Uploaded documents</h4><a href=\"#\">abc123.doc (wip)</a><h4>URL to get styles</h4><a href=\"{{ url }}\" ng-repeat=\"url in vm.project.designUrls\" target=\"_blank\">{{ url }}</a><h4>Fonts</h4><div class=\"flex middle\"><div class=\"big-a\">A</div><span>{{ vm.project.fontIds.join(\', \') }}</span></div><h4>Colors</h4><p>{{ vm.project.colorSwatchIds.join(\', \') }}</p><h4>Icons</h4><div ng-repeat=\"icon in vm.project.iconsetIds\" class=\"flex middle\"><img src=\"/images/{{ vm.imageMap[icon] }}.svg\" class=\"icon biggest\"/><span>{{ vm.textMap[icon] }}</span></div></li><li><h3>Development</h3><hr class=\"biggest\"/><h4>Uploaded Specs</h4><a href=\"#\">abc123.doc (wip)</a><h4>What level of security is needed?</h4><p>Security level needed: {{ vm.project.securityLevel }}</p><h4>Access to data offline?</h4><p ng-if=\"vm.project.offlineAccess\">Yes, access to offline data is needed.</p><p ng-if=\"!vm.project.offlineAccess\">No, access to offline data is not needed.</p><h4>Is there any level of personal information? (stored or transmitted)?</h4><p ng-if=\"vm.project.usesPersonalInformation\">Yes, storing and/or transmitting personal information is needed.</p><p ng-if=\"!vm.project.usesPersonalInformation\">No, storing and/or transmitting personal information is not needed.</p><h4>How many 3rd party integrations?</h4><p>There are {{ vm.project.numberOfApiIntegrations }} integrations needed.</p></li></ul></div>");}]);
(function() {
  'use strict';
  var directive;
...
(function() {
  ...
  OpenProjectsController = function($scope, ProjectsAPIService, CopilotProjectDetailsAPIService) {
    ...
    vm.claim = function(projectId) {
      ...
      resource.$promise.then(function(response) {
        return vm.claimed[projectId] = true;
      });
      return resource.$promise["finally"](function() {
        return vm.claiming[projectId] = false;
      });
    };
...
(function() {
  ...
  ProjectDetailsController = function($scope, ProjectsAPIService) {
    ...
    activate = function() {
      var params, resource;
      $scope.userType || ($scope.userType = 'customer');
      vm.loading = true;
      params = {
        id: $scope.id
      };
