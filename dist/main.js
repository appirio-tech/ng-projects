...
angular.module("appirio-tech-ng-projects").run(["$templateCache", function($templateCache) {$templateCache.put("views/claimed-projects.directive.html","<loader ng-show=\"vm.loading\"></loader><ul class=\"flex wrap\"><li ng-repeat=\"project in vm.projects track by $index\" fitted-width=\"fitted-width\"><header><a ui-sref=\"copilot-project-details({ id: project.id })\"><h5>{{ project.name || \'Unnamed Project\' }}</h5></a><p class=\"type\">{{ vm.typeMap[project.projectType] }} - 10/23/2015</p></header><hr/><main ng-if=\"project.status == \'Assigned\'\" class=\"flex column middle center\"><h6>Projected Claimed</h6><img src=\"/images/design.svg\" ng-if=\"project.projectType == \'DESIGN\'\" class=\"icon biggest\"/><img src=\"/images/development.svg\" ng-if=\"project.projectType == \'DESIGN_AND_CODE\'\" class=\"icon biggest\"/><a ui-sref=\"copilot-project-details({ id: project.id })\" class=\"action button\">estimate</a></main><main ng-if=\"project.status == \'Estimate\'\" class=\"flex column middle center\"><h6>Projected Estimated</h6><img src=\"/images/define-feature.svg\" class=\"icon biggest\"/><p>Client is reviewing estimate.</p></main><main ng-if=\"project.status == \'Approved\'\" class=\"flex column middle center\"><h6>Project Approved</h6><img src=\"/images/brand-reqs.svg\" class=\"icon biggest\"/><a ui-sref=\"copilot-project-details({ id: project.id })\" class=\"action button\">create challenges</a></main><main ng-if=\"project.status == \'Launched\'\" class=\"flex column middle center\"><img src=\"/images/features.svg\" class=\"icon biggest\"/><h6>Project launched</h6></main><main ng-if=\"project.status == \'Complete\'\" class=\"complete flex column middle center\"><img src=\"/images/features.svg\" class=\"icon biggest\"/><h6>Project complete</h6></main></li></ul><div ng-hide=\"vm.loading || vm.projects.length == 0\" class=\"no-projects\"><p>You have not started any projects.</p></div>");
...
$templateCache.put("views/ng-projects.directive.html","<loader ng-show=\"vm.loading\"></loader><ul class=\"flex wrap\"><li ng-repeat=\"project in vm.projects track by $index\" fitted-width=\"fitted-width\" class=\"elevated-bottom\"><header><a ui-sref=\"timeline({ workId: project.id })\"><h5>{{ project.name || \'Unnamed Project\' }}</h5></a><p class=\"type\">{{ vm.typeMap[project.projectType] }} - {{ project.status }}</p></header><main ng-if=\"project.status == \'Incomplete\'\" class=\"incomplete flex column middle center\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/project-incomplete.svg\" class=\"icon big\"/><h6>Project setup incomplete</h6></div><footer><a ui-sref=\"submit-work({ id: project.id })\" class=\"button action\">continue setup</a></footer></main><main ng-if=\"project.status == \'Submitted\'\" class=\"submitted flex column\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/project-submitted.svg\" class=\"icon big\"/><h6>Project submitted</h6></div><footer><p>You are waiting for project approval</p><p>This should take about 1 day</p></footer></main><main ng-if=\"project.status == \'Assigned\'\" class=\"assigned flex column\"><div class=\"flex column middle center flex-grow\"><h6>Meet your co-pilot</h6><avatar ng-src=\"{{project.copilot.avatar}}\" class=\"icon big\"></avatar><p>{{ project.copilot.handle || \'n/a\' }}</p></div><footer><a ui-sref=\"messaging({ id: project.id, threadId: \'threadfor-\' + project.id })\" class=\"button action\">send a message</a></footer></main><main ng-if=\"project.status == \'Estimate\'\" class=\"estimated flex column\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/quote-generated.svg\" class=\"icon big\"/><h6>Quote Generated</h6></div><footer><a ui-sref=\"timeline({ workId: project.id })\" class=\"button action\">view quote</a></footer></main><main ng-if=\"project.status == \'Approved\'\" class=\"approved flex column\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/project-approved.svg\" class=\"icon big\"/><h6>Project Approved</h6></div><footer><p>Blah blah blah blah</p><p>Blah blah blah blah</p></footer></main><main ng-if=\"project.status == \'Launched\'\" class=\"launched flex column\"><div class=\"flex column middle center flex-grow\"><img src=\"/images/project-launched.svg\" class=\"icon big\"/><h6>Project launched</h6></div><footer><p>Design work is in progress</p><p>Get design submissions in several days.</p></footer></main><main ng-if=\"project.status == \'Complete\'\" class=\"complete flex column middle center\"><div class=\"icon big warning\"></div><h6>Project complete!</h6><button>deploy my app</button></main></li></ul><div ng-hide=\"vm.loading || vm.projects.length == 0\" class=\"no-projects\"><p>You have not started any projects.</p></div>");
$templateCache.put("views/open-projects.directive.html","<loader ng-show=\"vm.loading\"></loader><ul class=\"flex wrap\"><li ng-repeat=\"project in vm.projects track by $index\" fitted-width=\"fitted-width\"><loader ng-show=\"vm.claiming[project.id]\"></loader><header><a ui-sref=\"copilot-project-details({ id: project.id })\"><h5>{{ project.name || \'Unnamed Project\' }}</h5></a><p class=\"type\">{{ vm.typeMap[project.projectType] }} - 10/23/2015</p></header><hr/><main class=\"flex column middle center\"><img src=\"/images/design.svg\" ng-if=\"project.projectType == \'DESIGN\'\" class=\"flex-grow\"/><img src=\"/images/design-development.svg\" ng-if=\"project.projectType == \'DESIGN_AND_CODE\'\" class=\"flex-grow\"/><footer><button ng-click=\"vm.claim(project.id)\" ng-hide=\"vm.claimed[project.id]\" class=\"action button\">claim project</button><div ng-show=\"vm.claimed[project.id]\" class=\"flex middle center\"><div class=\"checkmark-white-house\"><div class=\"icon checkmark-white small\"></div></div><div class=\"claimed\">project claimed</div></div></footer></main></li></ul><div ng-hide=\"vm.loading || vm.projects.length == 0\" class=\"no-projects\"><p>You have not started any projects.</p></div>");
...
(function() {
  ...
  OpenProjectsController = function($scope, ProjectsAPIService, CopilotProjectDetailsAPIService) {
    ...
    vm.claim = function(id) {
      ...
      resource.$promise.then(function(response) {
        return vm.claimed[id] = true;
      });
      return resource.$promise["finally"](function() {
        return vm.claiming[id] = false;
      });
    };
